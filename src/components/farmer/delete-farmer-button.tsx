...
import { deleteCustomer } from "@/app/farmer/actions";
...
/** Delete action for farmer (land) records — not billing customers. */
export function DeleteFarmerButton({ farmerId, label, className }: Props) {
    ...
    <>
      ...
      >
        <div className="border-b border-[#D1D5DB] px-5 py-4">
          <h2 className="text-base font-semibold">Delete farmer</h2>
        ...
        <div className="flex flex-col-reverse gap-2 px-5 py-4 sm:flex-row sm:justify-end">
          ...
          <button
            type="button"
            onClick={() => startTransition(() => void deleteCustomer(farmerId))}
            disabled={isPending}
