...
function derivedInputFromForm(values: Record<string, string>) {
  return {
    ...
    rentalDdPart1Amount: values.rentalDdPart1Amount,
    otherCharges: values.otherCharges,
    cropCompensation: values.cropCompensation,
...
function derivedInputFromCustomer(customer: Customer) {
  return {
    ...
    tdsAmount: customer.tdsAmount,
    loanAmount: customer.loanAmount,
    leaseAmount: customer.leaseAmount,
    rentalDdPart1Amount: customer.rentalDdPart1Amount,
    otherCharges: customer.otherCharges,
    cropCompensation: customer.cropCompensation,
