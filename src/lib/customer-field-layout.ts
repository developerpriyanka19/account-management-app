...
export const CUSTOMER_FIELD_LAYOUT: CustomerLayoutRow[] = [
  ...
  { row: "field", label: "Bank Loan", name: "loanAmount", inputType: "number", variant: "money" },
  ...
  { row: "parent", label: "Shortage Amount Through Cheque (1st Time)" },
  {
    row: "field",
    label: "Cheque Amount",
  ...
  { row: "parent", label: "Shortage Amount Through Cheque (2nd Time)" },
  {
    row: "field",
    label: "Cheque Amount",
