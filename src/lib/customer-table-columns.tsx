...
function farmerDerivedFromRow(row: CustomerListRow): FarmerDerivedFields {
  return computeFarmerDerivedFields({
    ...
    rentalDdPart1Amount: row.rentalDdPart1Amount,
    otherCharges: row.otherCharges,
    cropCompensation: row.cropCompensation,
...
export function buildCustomerTableColumns(
  ...
  return [
    ...
    columnGroup("otherChargesGroup", "Other Charges", {
      id: "otherCharges",
    ...
    columnGroup("cropCompensationGroup", "Crop Compensation", {
      id: "cropCompensation",
    ...
    columnGroup("totalPaidToFarmerGroup", "Total Paid to Farmer", {
      id: "totalPaidToFarmer",
      header: "Total Paid to Farmer",
      cell: ({ row }) => computedColumnCell(row.original, "totalPaidToFarmer"),
      size: 148,
      minSize: 128,
    }, { subHeader: null }),
    columnGroup("atl", "ATL", {
